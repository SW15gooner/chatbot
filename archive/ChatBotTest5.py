...
class Application(tk.Frame):
    def __init__(self, master):
        ...
        self.text.insert("end", "Hello You. Do you want to play a game?\n\nI am an AI Learning ChatBot\nI have learnt some standard phrases, I then pickup what you say and search a semantics Database for a response and store it in a temporary SQLite DB to learn more and reference again. Which will vanish when I do, when you close this\n")
