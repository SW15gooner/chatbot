...
class Application(tk.Frame):
    def __init__(self, master):
        ...
        self.text.insert("end", "Hello You. Do you want to play a game?\n\nI am an AI Learning ChatBot I pickup what you say and search a *NEW* semantics Database, and some known phrases, for a response. I talk gibberish for a while, whilst I am learning. The more you ask, the more I learn.")
